        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-primary-foreground/80 mb-6 leading-relaxed">
              A North Texas-based ASC partnered with Accelon in a time of deep 
              financial trouble. In under 15 months, our comprehensive RCM 
              engagement turned around their declining revenue and established 
              sustainable operational improvements.
            </p>
            <ul className="space-y-3 text-primary-foreground/80">
              <li className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-accent" />
                Revenue improved by 40%+
              </li>
              <li className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-accent" />
                AR days reduced from 65 to 28
              </li>
              <li className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-accent" />
